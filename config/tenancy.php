...
return [
    ...
    'id_generator' => UUIDGenerator::class, // unused in practice — tenant ids are always passed explicitly (subdomain slug)
    ...
    'bootstrappers' => [
        ...
        // Custom prefix-based cache scoping: v3 only ships the tags-based CacheTenancyBootstrapper,
    ...
    'database' => [
         ...
         */
        'prefix' => 'zenon_tenant_',
        'suffix' => env('TENANCY_DB_SUFFIX', ''), // '.sqlite' in tests → file-per-tenant sqlite DBs
     ...
     */
    'cache' => [
        'tag_base' => 'tenant', // Unused — the tags-based bootstrapper is not registered (see 'bootstrappers').
        'prefix_base' => 'tenant_', // Consumed by our PrefixCacheTenancyBootstrapper: cache.prefix .= prefix_base + tenant id.
    ],
